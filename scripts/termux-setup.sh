...
function installMissingPackages {
	local packageFile=$USER_HOME/dotfiles/scripts/termux-packages.txt
...
# Installs the popular 'oh-my-zsh' plugin and changes the system
# shell to use zsh, configured with this plugin
function installOhMyZsh {
	git clone https://github.com/robbyrussell/oh-my-zsh $USER_HOME/.oh-my-zsh
...
function run {
	...
	# Start ZSH
	clear
	log "Finished! Type zsh to get started w/ your new awesome config!"
}
